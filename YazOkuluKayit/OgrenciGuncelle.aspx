...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder2" runat="Server">
    <form id="Form1" runat="server">
        <div class="form-group">
            <div>
                <asp:Label for="TxtId" runat="server" Text="Öğrenci Adı" Style="font-weight: 700"></asp:Label>
            ...
            <br />
            <div>
                <asp:Label for="TxtFotograf" runat="server" Text="Öğrenci Fotoğraf" Style="font-weight: 700"></asp:Label>
                <asp:TextBox ID="TxtFotograf" runat="server" CssClass="form-control"></asp:TextBox>
            </div>
        </div>

        <asp:Button runat="server" Text="Güncelle" CssClass="btn btn-warning" OnClick="Unnamed7_Click" />
    </form>
</asp:Content>
