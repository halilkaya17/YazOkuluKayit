    ...
    public class DALOgrenci
    {
        ...
        public static List<EntityOgrenci> OgrenciListesi()
        {
            ...
            EntityOgrenci ent = new EntityOgrenci();
                ...
                ent.BAKIYE = dr["OgrBakiye"].ToString();
                degerler.Add(ent);
            }
            dr.Close();
            return degerler;
        ...
        {
            SqlCommand komut5 = new SqlCommand("Update Tbl_Ogrenci Set  " +
                "OgrAd=@P1, OgrSoyad=@P2, OgrNumara=@P3, OgrFotograf=@P4, OgrSifre=@P5 where OgrId=@P6", Baglanti.bgl);
